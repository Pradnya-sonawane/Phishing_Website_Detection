...
# loaded_model = joblib.load('model development/model_original_XGBoost.joblib')
# loaded_model = joblib.load('model development/parameter_tune.joblib')
scaler = joblib.load('model development/scaler.pkl')
feature_columns = joblib.load("model development/feature_columns.pkl")
...
#     return "Legitimate" if prediction == 0 else "Suspicious"
#     # return prediction
...
url_to_check = "http://rockysite.net/i_logins/"
